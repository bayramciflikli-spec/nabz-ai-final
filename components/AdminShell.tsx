...
import { GripVertical, ExternalLink, Shield } from "lucide-react";
...
/**
 * Admin panel kabuğu: NABZ-AI üzerinde tam kontrol buradan.
 * Ana uygulama ayrı; tüm müdahaleler bu panel üzerinden.
 */
export function AdminShell({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="flex min-h-screen bg-[#0a0a0a] text-white">
      <aside className="w-[260px] shrink-0 bg-[#111] border-r border-white/10 flex flex-col p-6">
