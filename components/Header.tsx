...
export function Header() {
  ...
  if (pathname === "/landing" || pathname === "/" || pathname?.startsWith("/search") || pathname === "/mall" || pathname?.startsWith("/project/") || pathname?.startsWith("/shorts/") || pathname?.startsWith("/admin")) return null;
