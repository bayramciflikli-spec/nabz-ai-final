...
export async function GET(request: NextRequest) {
  ...
  const manifest = {
    ...
    icons: (() => {
      const iconBase = base ? `${base}/logo.png` : "/logo.png";
      return [
        { src: iconBase, sizes: "72x72", type: "image/png", purpose: "any" },
        { src: iconBase, sizes: "96x96", type: "image/png", purpose: "any" },
        { src: iconBase, sizes: "128x128", type: "image/png", purpose: "any" },
        { src: iconBase, sizes: "144x144", type: "image/png", purpose: "any" },
        { src: iconBase, sizes: "192x192", type: "image/png", purpose: "any maskable" },
        { src: iconBase, sizes: "384x384", type: "image/png", purpose: "any" },
